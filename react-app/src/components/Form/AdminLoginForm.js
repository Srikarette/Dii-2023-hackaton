      ...
      <div className="bg-white p-8 rounded-md shadow-md w-80 border-1">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-blue-500  py-2 px-4 rounded-lg hover-bg-blue-600 focus:outline-none focus-bg-blue-600 duration-300 hover:bg-blue-900 text-white tracking-wider"
            >
              Login
            </button>
          </div>
